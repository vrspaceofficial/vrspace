...
const Content = () => {
  return (<>
    ...
    <div className="h-72 sm:h-96 flex  items-center mx-auto">
      ...
      <div className='sm:w-3/12 w-6/12 ml-5 sm:ml-44 hover:cursor-default'>
        ...
        <p className='mt-3 text-sm sm:text-md capitalize'>The Genie AR Glasses can be used in various sectors millitary, educational, health, SpaceResearch Learning and development Sports, Entertainment and even for conference meetings and many more. <span className='text-xs hover:cursor-pointer hover:text-yellow-900 font-bold text-blue-800'>coming soon..</span></p>
      </div>
    </div>



    <div className="h-72 sm:h-96 flex  items-center justify-end mx-auto">
